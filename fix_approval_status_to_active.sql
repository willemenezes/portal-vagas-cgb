-- Verificar os valores válidos do enum job_approval_status
SELECT enumlabel FROM pg_enum WHERE enumtypid = (
    SELECT oid FROM pg_type WHERE typname = 'job_approval_status'
) ORDER BY enumlabel;

-- Atualizar função create_job_from_request para criar vagas ativas
...
BEGIN
    ...
    -- Inserir nova vaga com approval_status ativo
    BEGIN
        INSERT INTO public.jobs (
            ...
            req_data.benefits,
            req_data.workload,
            'ativo',  -- Status de aprovação ativo
...
-- Atualizar função approve_and_create_job também
...
BEGIN
    ...
    -- Depois, criar a vaga com status ativo
    BEGIN
        INSERT INTO public.jobs (
            title,
            department,
