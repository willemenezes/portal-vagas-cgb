-- Função final corrigida para criar vaga a partir de solicitação
-- Esta versão não especifica approval_status, deixando o valor padrão da coluna
...
BEGIN
    ...
    -- Inserir nova vaga SEM especificar approval_status
    -- Deixa o valor padrão da coluna ser aplicado
