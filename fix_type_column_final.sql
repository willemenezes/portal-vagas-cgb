-- Primeiro, vamos verificar os valores válidos do enum contract_type
SELECT enumlabel FROM pg_enum WHERE enumtypid = (
    SELECT oid FROM pg_type WHERE typname = 'contract_type'
) ORDER BY enumlabel;
...
BEGIN
    ...
    INSERT INTO public.jobs (
        ...
        req_data.city,
        req_data.state,
        COALESCE(req_data.type, 'CLT')::contract_type,  -- Cast explícito para enum
