-- Migração para adicionar campos de quantidade e validade
...
-- 9. Atualizar RLS policies para incluir novos campos
-- (As policies existentes já cobrem esses campos por usar SELECT *)
